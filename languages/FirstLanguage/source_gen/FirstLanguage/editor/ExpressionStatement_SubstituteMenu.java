...
public class ExpressionStatement_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Wrap_syupv4_a(), CONCEPTS.ExpressionStatement$ys));
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for " + "ExpressionStatement", new SNodePointer("r:5f2c1334-fc6f-4612-8049-05cb34867353(FirstLanguage.editor)", "8046047320587633439")));
    try {
  ...
  private class SMP_Wrap_syupv4_a extends WrapperSubstituteMenuPart {
    ...
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Expression", new SNodePointer("r:5f2c1334-fc6f-4612-8049-05cb34867353(FirstLanguage.editor)", "8046047320587633440")));
      try {
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item) {
        ...
        public SAbstractConcept getOutputConcept() {
          return CONCEPTS.ExpressionStatement$ys;
        }
        @Nullable
        @Override
        public SNode createNode(@NotNull String pattern) {
          ...
          SNode exprstmt = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x7948aebf5e1b4d63L, 0xb7a7a346bd29db6dL, 0x6fa94d688599e262L, "FirstLanguage.structure.ExpressionStatement"));
          SLinkOperations.setTarget(exprstmt, LINKS.expr$uBM0, nodeToWrap);
          return exprstmt;
        }
        @Override
